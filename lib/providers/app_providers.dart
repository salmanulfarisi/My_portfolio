...
class AppProviders extends ChangeNotifier {
  static AppProviders state(BuildContext context, [bool listen = false]) =>
      Provider.of<AppProviders>(context, listen: listen);
  ...
  void init() async {
    ...
    if (theme == null) {
      await prefs.setString(
          'theme', ThemeData.light.toString().split('.').last);
